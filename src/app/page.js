    ...
    <div className="mx-auto bg-gray-400 ">
      ...
      >
        <div className="min-h-[600px] py-4 flex-center items-stretch gap-2 flex-col md:flex-row w-screen container mx-auto">
          ...
          {/* left side */}
          <div className="flex-1 bg-gray-600 p-3 min-h-[400px] relative ">
            <Image
              fill
              ...
              src="https://img.freepik.com/premium-vector/hero-header-landing-page-ecommerce_176048-9.jpg?w=2000"
              alt=""
            />
          </div>
        </div>
